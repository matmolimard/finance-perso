...
def backfill_v2_market_history(
    ...
    *,
    ...
    underlyings_result = update_v2_underlyings(data_dir, headless=headless, years=years)
    return {
        "ok": len(uc_errors) == 0 and underlyings_result.get("ok", False),
        "period": {"start_date": start_date.isoformat(), "end_date": end_date.isoformat(), "years": years},
